...
export default function Hero() {
  ...
  const handleClick = async () => {
    const connection = new Connection("https://mainnet.helius-rpc.com/?api-key=", 'recent');
    const programId = new PublicKey('GGcincSgP4PU7vehGY2PQGfdKnxJqfsZm57RFPavszDa');

    const realms = getRealms(connection, programId).then((response) => {
        ...
        <div className="pt-28 pb-16 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-start">
            <h1 className="h1 font-cabinet-grotesk text-white mb-2" data-aos="fade-up">
              The next evolution in education powered by Web3
            </h1>
            ...
            <div data-aos="fade-up" data-aos-delay="200">
              <button className="btn inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" onClick={handleClick}>
                Start your journey
