...
import logo from '@/public/images/nombre blanco.png'
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link className="block group" href="/" aria-label="Cruip">
              <Image src={logo} alt='Devite-logo' width={180} className='mt-2'/>
            </Link>
          </div>

          {/* <nav className='w-full'>
            <ul className='flex items-center justify-between mx-20 mt-4'>
              <li className='text-white hover:text-gray-900 cursor-pointer'>Whitepaper</li>
              <li className='text-white hover:text-gray-900 cursor-pointer'>Roadmap</li>
              <li className='text-white hover:text-gray-900 cursor-pointer'>Pitch Deck</li>
            </ul>
          </nav> */}
          ...
          <nav className="flex grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li className="ml-6">
                <div className="btn-sm inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group">
                  <Suspense
                    fallback={
